...
const bucketName = 'skul-cart-ecommerce-1';
const accessKeyId = 'AKIAUVWCLOLSY3VRV3GV';
const secretAccessKey = '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';
aws.config.update({
  region,
  accessKeyId,
  secretAccessKey,
...
app.post('/order', (req, res) => {
  ...
  let transporter = nodemailer.createTransport({
    service: 'hotmail',
    auth: {
      user: 'skulcart2022@outlook.com',
      pass: 'ecommerce2022#',
    },
  });

  const mailOption = {
    from: 'skulcart2022@outlook.com',
    to: email.toString(),
