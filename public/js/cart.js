...
const createSmallCards = data => {
  ...
  <div class="sm-text">
    ...
    <p class="sm-description">${data.shortDescription}</p>
  </div>
  ...
  <button class="sm-delete-btn">
    <img src="img/close-removebg.png" alt="" />
  </button>
</div>
    `;
};
...
const setProducts = name => {
  ...
  if (data == null || data.length == 0) {
    element.innerHTML = `<img src="img/empty-cart-removebg.png" class="empty-img" alt="" />`;
  } else {
...
if (location.pathname == '/cart') setProducts('wishlist');
